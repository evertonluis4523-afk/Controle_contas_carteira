...
3. HTTPS é obrigatório para service worker, instalação e biometria.
4. Acesse pelo celular → menu do navegador → **"Adicionar à tela inicial"**.
...
- Gere os PNGs `icon-192.png` e `icon-512.png` (ex.: https://realfavicongenerator.net ou `npx pwa-asset-generator public/icons/icon.svg public/icons`).
- Coloque-os em `public/icons/` — o manifest já os referencia, incluindo versão maskable.
